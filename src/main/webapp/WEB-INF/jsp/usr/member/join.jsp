		...
		<form action="doJoin" method="post" class="card-body" onsubmit="joinFormOnSubmit(this); return false;" enctype="multipart/form-data">
			...
			<div class="form-control">
				...
				<div class="flex gap-2">
			        <input id="loginId" name="loginId" type="text" placeholder="아이디 입력" data-korName="아이디" class="input input-bordered w-full dupInput" minlength="8" maxlength="20" />
	        ...
	        <div class="form-control">
	            ...
	            <input id="loginPw" name="loginPw" type="password" placeholder="비밀번호 입력" data-korName="비밀번호" class="input input-bordered" minlength="10" maxlength="30" />
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <input id="loginPwChk" type="password" placeholder="비밀번호 확인 입력" data-korName="비밀번호확인" class="input input-bordered no-validation" minlength="10" maxlength="30" />
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <input name="name" type="text" placeholder="이름 입력" data-korName="이름" class="input input-bordered" minlength="2" maxlength="50" />
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <div class="flex gap-2">
		            <input id="nickname" name="nickname" type="text" placeholder="닉네임 입력" data-korName="닉네임" class="input input-bordered w-full dupInput" minlength="2" maxlength="12" />
	        ...
	        <div class="form-control">
	            ...
	            <input name="age" type="text" placeholder="나이 입력" data-korName="나이" class="input input-bordered" minlength="1" maxlength="3" />
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <div id="address" class="flex flex-col gap-2">
		            ...
		            <input type="text" id="detailAddress" placeholder="상세주소" class="input input-bordered w-full no-validation" />
	            </div>
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <input name="cellphoneNum" type="text" placeholder="전화번호 입력" data-korName="전화번호" class="input input-bordered" maxlength="13" />
	        </div>
	        ...
	        <div class="form-control">
	            ...
	            <div id="authCodeWrap" class="flex gap-2 hidden">
	            	<input id="authCode" type="text" placeholder="이메일 인증코드 입력 6자리" class="input input-bordered w-full" minlength="6" maxlength="6" />
