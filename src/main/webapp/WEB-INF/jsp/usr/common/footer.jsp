...
<footer class="min-w-[1024px]">
	<div class="p-10 bg-base-200 text-base-content">
		<div class="footer max-w-6xl mx-auto">
			<nav>
		   		<h6 class="footer-title">메인 목록</h6> 
			    <a class="link link-hover">Meow</a>
			    <a class="link link-hover">반려묘</a>
			    <a class="link link-hover">게시판</a>
			    <a class="link link-hover">고객센터</a>
			</nav> 
			<nav>
			    <h6 class="footer-title">게시판 바로가기</h6> 
			    <a class="link link-hover">전체</a>
			    <a class="link link-hover">공지사항</a>
			    <a class="link link-hover">자유</a>
			    <a class="link link-hover">반려묘</a>
			</nav> 
			<nav>
	...
	<div class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
		<div class="footer max-w-6xl mx-auto">
		 	<aside class="items-center grid-flow-col">
		   		...
		   		<p>ⓒ MEOW Corp.<br>Creating Meow sites since 2024</p>
			</aside> 
		 	<nav class="md:place-self-center md:justify-self-end">
		   		<div class="grid grid-cols-4 gap-3 items-center">
		   			<div class="w-6 h-6 pt-1"><a class="font-SBAggroB text-[28px] text-black">N</a></div>
	                <div class="w-6 h-6"><a><img src="/images/sns_login_icon/kakao.png" class="scale-[0.95]" /></a></div>
	                <div class="w-6 h-6 pt-0.5"><a><i class="fa-brands fa-google fa-xl" style="color: #000000;"></i></a></div>
	                <div class="w-6 h-6 pt-0.5"><a><i class="fa-brands fa-github fa-xl" style="color: #000000;"></i></a></div>
		   		</div>
			</nav>
		</div>
	</div>
